...
<Aside type="tip" title="Running under Podman?">
The image is a standard OCI artifact and runs rootless under Podman as-is. See [Podman](/deployment/podman/) for the runtime-specific details (SELinux volume labels, Quadlet units, rootless networking).
</Aside>
